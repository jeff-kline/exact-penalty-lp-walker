...
| 19 | 2026-08-18 | `ed4dc61` | primary agent, archive verification | Public tag and GitHub Release; GitHub-integration zipball pin; Zenodo record, DOI, metadata, license display, and downloaded file; archived-state audit | **ARCHIVED PASS.** The annotated `v0.1.0` tag resolves to `ed4dc6147653991aad2abd52b2681cdfe7c69444`. Two pre-Release GitHub API zipballs match at 2,368,081 bytes and SHA-256 `c8f719130088c73093087f48a677561640c57f833eff06efa22655574c15886d`. Zenodo version DOI `10.5281/zenodo.21998053` resolves publicly; title, creator, date, version, software type, repository, and GPL-3.0-only display match. Its downloaded file is byte-identical to the pinned zipball and carries `md5:7d825e0d615614a70726778c295aa60a`. The archived-state audit reports 11 pass, 0 warning, 0 fail. This is an archive-mechanics check, not peer review or a correctness certificate. |
